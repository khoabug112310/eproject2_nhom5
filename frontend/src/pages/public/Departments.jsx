...
export default function Departments() {
  ...
  return (
    <div className="app">
      {/* Page Header Banner - GIỮ NGUYÊN CŨ */}
      ...
      {/* Thay vì dùng class "home-grid" (bị chia cột lệch), ta đổi sang một container bao ngoài thoáng hơn 
        để phần "card" bên trong thoải mái bung full màn hình theo ý bạn.
      */}
      <div className="main-content-wrapper" style={{ padding: '0 20px', marginTop: '20px' }}>
        
        {/* Khung bao quanh (Card) - GIỮ NGUYÊN CŨ */}
        <div className="card" style={{ width: '100%', maxWidth: '100%' }}>
          
          {/* Search and Title Bar - GIỮ NGUYÊN CŨ */}
          ...
          {/* Department Grid - Đã được thêm style inline để tự động dàn đều card ra full màn hình.
            Khi màn hình rộng, các card chuyên khoa sẽ tự xếp thành 3, 4 hoặc 5 cột nhìn cực kỳ cân đối.
          */}
          <div 
