...
// Admin, Staff & Doctor - Doctor Schedule Management
router.get('/doctor-schedules', authenticateToken, authorizeRole(USER_ROLE.ADMIN, USER_ROLE.STAFF, USER_ROLE.DOCTOR), getAllSchedules);
